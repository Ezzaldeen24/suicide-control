  ...
  <div id="pageintro" class="hoc clear"> 
    ...
    <article>
      ...
      <p>SAFER CARE FOR THOSE AT RISK OF SUICIDE..<br>
        ...
        <a href="login.php" class="more-info">login to Know More</a>
      ...
      <ul class="nospace group">
        <li class="one_quarter">
          <article>
            ...
            <footer><a class="btn" a href="https://en.wikipedia.org/wiki/Social_isolation">See Details</a></footer>
          </article>
        </li>
        <li class="one_quarter">
          <article>
            ...
            <footer><a class="btn" a href="https://en.wikipedia.org/wiki/Post-traumatic_stress_disorder">See Details</a></footer>
          </article>
        </li>
        <li class="one_quarter">
          <article>
            ...
            <footer><a class="btn" a href="https://en.wikipedia.org/wiki/Substance_abuse">See Details</a></footer>
          </article>
        </li>
        <li class="one_quarter">
          <article>
            ...
            <footer><a class="btn" a href="https://en.wikipedia.org/wiki/Loss_aversion">See Details</a></footer>
          </article>
        </li>
      </ul>
    </section>
...
<!-- ################################################################################################ -->
<!-- ################################################################################################ -->
<div class="bgded overlay" style="background-image:url('image/ezz.jpg');">
...
<div class="bgded overlay" style="background-image:url('image/sea-and-the-rocks.jpg');"> 
  <!-- ################################################################################################ -->
